...
if [[ ! -z "${arc_packages}" ]]; then
	...
	for arc_package_name_version in "${arc_package_list[@]}"; do
		...
		echo "[info] curly.sh -of /tmp/${arc_package_name}.tar.xz -url https://archive.archlinux.org/packages/${arc_package_name_first_letter}/${arc_package_name}/${arc_package_name}-${arc_package_version}.pkg.tar.xz"
		curly.sh -of "/tmp/${arc_package_name}.tar.xz" -url "https://archive.archlinux.org/packages/${arc_package_name_first_letter}/${arc_package_name}/${arc_package_name}-${arc_package_version}.pkg.tar.xz"
